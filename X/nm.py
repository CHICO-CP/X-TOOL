...
Ezxx = ("This Script Generated By : E BOOS TOOLS\nBeta Test Module : V1\n=====================================\nResult Decrypt : ")
...
def main():
    ...
    formatted_text = decrypted_text.decode('utf-8').strip()  # استخدم strip() بدلاً من rstrip()
...
if __name__ == "__main__":  # استخدام __name__ الصحيح
    main()